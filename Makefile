...
HDFFS_OBJ:=wrapper_libc_autogenerated_real.o logger.o process_info.o hfile_ds.o chunksize.o hdir.o path_util.o hstack_tree.o env_util.o
...
wrapper_func.o: wrapper_func.c wrapper_libc_autogenerated_real.h

h5fs-wrapper.so: wrapper_func.o wrapper_libc_autogenerated.o $(HDFFS_OBJ) h5fs.o
	gcc $(LDFLAGS) -shared -o $@ $^ $(LDLIBS)
wrapper_libc_autogenerated_real.c wrapper_libc_autogenerated_real.h wrapper_libc_autogenerated.c: wrapper-gen/wrapper-gen.pl wrapper-gen/io-calls.c wrapper_func.c
...
test_h5fs_01_hfile_ds: test_h5fs_01_hfile_ds.o hfile_ds.o logger.o process_info.o chunksize.o path_util.o wrapper_libc_autogenerated_real.o
...
clean:
	rm -f *.o *.so test_rel2abs test_pathcmp test_env_util test_logger wrapper_libc_autogenerated* h5fs-repack h5fs-unpack h5fs-md5sum-size h5fs-wrap
