...
HDFFS_OBJ:=logger.o process_info.o hfile_ds.o chunksize.o hdir.o path_util.o hstack_tree.o env_util.o
...
h5fs-wrapper.so: wrapper_func.o wrapper_libc_autogenerated.o wrapper_libc_autogenerated_real.o $(HDFFS_OBJ) h5fs.o
...
test_h5fs_01_hfile_ds: test_h5fs_01_hfile_ds.o hfile_ds.o logger.o process_info.o chunksize.o path_util.o
